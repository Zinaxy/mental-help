...
const IntroService = () => {
  return (
    <section id='about-us' className='flex justify-center  mt-10'>
        ...
        <div className='mx-2 md:mx-0 my-10 md:flex justify-between space-x-4 gap-4'>
          <div className='w-full outline-1 text-start'>
            <img
              src={bg2}
              alt=''
              className='hover:brightness-75 rounded-lg w-full h-60'
            />
            ...
            <p className='flex text-start mt-5 leading-normal text-slate-600 dark:text-slate-200 text-lg'>
              ...
              voluptatibus esse fuga sit! Numquam.Lorem ipsum dolor sit, amet
              consectetur adipisicing elit. Dolor, doloremque harum? A odio
              officia totam velit corrupti eligendi aliquam dignissimos
              reiciendis commodi assumenda, voluptatem, est voluptatum eum nobis
              quae minus.
            </p>
            <Link
              to='/about-us'
